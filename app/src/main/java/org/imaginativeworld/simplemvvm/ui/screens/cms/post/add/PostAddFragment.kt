...
import org.imaginativeworld.simplemvvm.databinding.FragmentCmsPostAddBinding
...
@AndroidEntryPoint
class PostAddFragment : Fragment(R.layout.fragment_cms_post_add), CommonFunctions {
    private val args: PostAddFragmentArgs by navArgs()

    private lateinit var binding: FragmentCmsPostAddBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding = FragmentCmsPostAddBinding.bind(view)
